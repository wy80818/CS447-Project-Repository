...
export default function Home() {
  ...
  const goToLoginExtra = async () => {
    try {
      const response = await fetch("http://localhost:5050/init-extra", {
        method: "POST"
      });
  ...
  return (
    <div style={{ textAlign: "center", padding: "4rem" }}>
      ...
      <button onClick={goToLoginExtra} style={{ marginTop: "2rem", padding: "0.5rem 1rem" }}>
